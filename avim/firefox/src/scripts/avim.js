 ...
 * Modified by Nguyen Duc Chung <chung1905 (at) gmail (dot) com>
 *
 * My changes is published by GPLv3.
 *
 * Changes:
 *  - Make it work inside Firefox Extension
 *  - Refactor
 */
...
function ckspell(word, k) {
    ...
    var uw = upperCase(word), tw = uw, update = false, gi = "IO", noAOEW = "OE,OO,AO,EO,IA,AI".split(','), noAOE = "OA",
        test, a, b;
...
function start(obj, key) {
    ...
    AVIMObj.oc = obj;
    var telex = "D,A,E,O,W,W".split(','), vni = "9,6,6,6,7,8".split(','), viqr = "D,^,^,^,+,(".split(','),
...
function findC(word, k, sf) {
    ...
    var str = "", res, cc = "", pc = "", tE = "", vowA = [], s = "ÂĂÊÔƠƯêâăơôư", c = 0, dn = false,
        uw = upperCase(word), tv, g;
    var DAWEOFA = upperCase(AVIMObj.aA.join() + AVIMObj.eA.join() + AVIMObj.mocA.join() + AVIMObj.trangA.join() + AVIMObj.oA.join() + AVIMObj.english),
        h, uc;
    ...
    if ((c == 1) || (uk == AVIMObj.Z)) {
        ...
        var c2 = 0, fdconsonant, sc = "BCD" + fromCharCode(272) + "GHKLMNPQRSTVX",
...
function main(word, k, i, a, noNormC) {
    var uk = upperCase(k), bya = [AVIMObj.db1, AVIMObj.ab1, AVIMObj.eb1, AVIMObj.ob1, AVIMObj.mocb1, AVIMObj.trangb1],
...
function DAWEOF(cc, k, g) {
    ...
    var ccA = [AVIMObj.aA, AVIMObj.mocA, AVIMObj.trangA, AVIMObj.eA, AVIMObj.oA],
        ccrA = [AVIMObj.arA, AVIMObj.mocrA, AVIMObj.arA, AVIMObj.erA, AVIMObj.orA];
